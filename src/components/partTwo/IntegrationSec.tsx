        ...
        {[0, 1].map((i) => (
          ...
          >
            <div className="interbanner_text">
              <h3>{t(i === 0 ? "integration.partner_title" : "integration.courier_title")}</h3>
              <p>{t(i === 0 ? "integration.partner_text" : "integration.courier_text")}</p>
              <button className="pm-button white">
                <span>{t(i === 0 ? "integration.partner_button" : "integration.courier_button")}</span>
              </button>
            </div>
